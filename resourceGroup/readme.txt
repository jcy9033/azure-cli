...
PowerShell에서 스크립트 실행 권한을 부여하기 위해, Set-ExecutionPolicy 명령어를 사용할 수 있습니다. 이는 스크립트를 실행하기 전에 필요한 보안 설정을 조정하는 데 사용됩니다. 
다음은 main.ps1 파일에 대해 스크립트 실행 권한을 설정하는 방법입니다.
